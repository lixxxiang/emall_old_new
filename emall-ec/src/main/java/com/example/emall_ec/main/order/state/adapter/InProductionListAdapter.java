...
public class InProductionListAdapter extends BaseAdapter {
    ...
    InProductionDelegate delegate;
    public InProductionListAdapter(InProductionDelegate delegate, List<OrderDetail> dataList,
