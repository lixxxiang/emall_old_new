...
//        EmallLogger.d(typedValue.data.)
    ...
    private fun initMap() {
        ...
        val listener: BaiduMap.OnMapStatusChangeListener = object : BaiduMap.OnMapStatusChangeListener {
            ...
            override fun onMapStatusChangeFinish(p0: MapStatus?) {
                val temp = DimenUtil().dip2px(context, ((DimenUtil().px2dip(context, DimenUtil().getScreenHeight(context).toFloat()) - 76 - 92 - 250) * 0.4 + 76).toFloat())
                Handler().postDelayed({

                    if (context != null) {
                        val ltp = Point()
                        ltp.x = ((DimenUtil().getScreenWidth(context).toFloat() - DimenUtil().dip2px(context, 250.0F)) / 2).toInt()
                        ltp.y = temp
                        val lt = mBaiduMap!!.projection.fromScreenLocation(ltp)

                        val rbp = Point()
                        rbp.x = ((DimenUtil().getScreenWidth(context).toFloat() - DimenUtil().dip2px(context, 250.0F)) / 2).toInt() + DimenUtil().dip2px(context, 250.0F)
    ...
    private fun initViews() {
        ...
        topRl!!.id = 1
        val topRlHeight = (DimenUtil().px2dip(context, DimenUtil().getScreenHeight(context).toFloat()) - 76 - 92 - 250) * 0.4
