...
public class HomePageListViewAdapter extends BaseAdapter {
    ...
    private List<HomePageBean.DataBean.MixedContentListBean> homePageData;

    public HomePageListViewAdapter() {
        super();
    }

    public HomePageListViewAdapter(Context context, List<HomePageBean.DataBean.MixedContentListBean> homePageData) {
        super();
