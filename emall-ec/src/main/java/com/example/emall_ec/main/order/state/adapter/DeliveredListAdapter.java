...
import com.example.emall_ec.main.order.state.waste.DeliveredDelegate;
...
public class DeliveredListAdapter extends BaseAdapter {
    ...
    DeliveredDelegate delegate;
    public DeliveredListAdapter(DeliveredDelegate delegate, List<OrderDetail> dataList,
