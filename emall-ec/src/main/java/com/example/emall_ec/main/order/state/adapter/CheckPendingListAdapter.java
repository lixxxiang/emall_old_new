...
import com.example.emall_ec.main.order.state.waste.CheckPendingDelegate;
...
public class CheckPendingListAdapter extends BaseAdapter {
    ...
    CheckPendingDelegate delegate;
    public CheckPendingListAdapter(CheckPendingDelegate delegate, List<OrderDetail> dataList,
